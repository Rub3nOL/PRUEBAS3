...
public class AdminPanelFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnImporExpor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnImporExporActionPerformed(evt);
            }
        });
        panelLateral.add(btnImporExpor, new org.netbeans.lib.awtextra.AbsoluteConstraints(8, 132, 174, 40));

        btnInventario.setBackground(new java.awt.Color(24, 95, 165));
        btnInventario.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        btnInventario.setForeground(new java.awt.Color(255, 255, 255));
        btnInventario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/caja.png"))); // NOI18N
        ...
        panelLateral.add(btnInventario, new org.netbeans.lib.awtextra.AbsoluteConstraints(8, 40, 174, 40));
        ...
        tablaInventario.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombre", "Descripción", "Categoria", "Estado", "Cantidad", "Ubicacion"
            }
        ) {
